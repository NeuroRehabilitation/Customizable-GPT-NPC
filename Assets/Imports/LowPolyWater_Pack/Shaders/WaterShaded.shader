...
CGINCLUDE 
	    ...
	    v2f vert(appdata_full v)
    {
        ...
        half2 tileableUv = mul(unity_ObjectToWorld, (v.vertex)).xz + half2(0.0, _Time.y * 0.05);
...
{
    // Added scrolling mechanism, _Time.y for vertical scrolling. Modify for your needs.
    half2 scroll = _Time.y * _MainTexTiling.xy;

    // Apply scrolling to UVs
    half4 baseColor = tex2D(_MainTex, input.posWorld.xz * _MainTexTiling.xy + scroll);
