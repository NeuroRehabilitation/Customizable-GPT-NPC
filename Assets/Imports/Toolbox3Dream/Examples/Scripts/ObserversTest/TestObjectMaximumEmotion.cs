...
/// <summary>
/// Test script to show how a sphere reacts to Trigger3Dream called "MaximumEmotion"
/// Change the color according the EmotionType received and change scale between 1 and 5 depending on its IntensityLevel.
/// </summary>
public class TestObjectMaximumEmotion : MonoBehaviour, ITriggered3Dream {
    ...
    {
        if (data.TriggerId == "MaximumEmotion")
        {
