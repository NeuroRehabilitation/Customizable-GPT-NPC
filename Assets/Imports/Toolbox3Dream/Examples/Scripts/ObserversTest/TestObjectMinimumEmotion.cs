...
/// <summary>
/// Test script to show how a sphere reacts to Trigger3Dream called "MinimumEmotion"
/// Change the color according the EmotionType received and change scale between 1 and 5 depending on its IntensityLevel.
/// </summary>
public class TestObjectMinimumEmotion : MonoBehaviour, ITriggered3Dream {
    ...
    {
        if (data.TriggerId == "MinimumEmotion")
        {
