...
{
    /// <summary>
    /// The class InterfaceHelper is used to identify the objects that are implementing specific 3Dream interfaces in order to execute events
    /// in those objects when a 3Dream trigger is activated.
    /// 
    /// Code from: http://wiki.unity3d.com/index.php/Interface_Finder#Class_itself
    /// Usage:
    ///     \code{.cs}
